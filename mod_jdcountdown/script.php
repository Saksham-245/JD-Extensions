 ...
 */
class mod_jdcountdownInstallerScript
{
	/**
    ...
    */
	 public function displayWelcome($parent) {
      ?>
      <style>
         .astroid-install {
            margin: 20px 0;
      ...
      <div class="astroid-install">
         ...
         <div class="install-message">
            ...
            <p>JD Countdown is a highly customizable yet easy to setup responsive countdown / count up module for Joomla 3.x</p>

         </div>
         <div class="astroid-install-actions">
            <a href="index.php?option=com_modules" class="btn btn-default">Get started</a>
         </div>
