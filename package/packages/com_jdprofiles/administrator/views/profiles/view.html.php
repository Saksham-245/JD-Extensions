 ...
 * @since  1.6
 */
class JdprofilesViewProfiles extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JdprofilesHelper::addSubmenu('profiles');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JDPROFILES_TITLE_PROFILES'), 'profiles.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_jdprofiles&view=profiles');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_JDPROFILES_PROFILES_NAME'),
			'a.`state`' => JText::_('JSTATUS'),
			'a.`email`' => JText::_('COM_JDPROFILES_PROFILES_EMAIL'),
			'a.`phone`' => JText::_('COM_JDPROFILES_PROFILES_PHONE'),
			'a.`designation`' => JText::_('COM_JDPROFILES_PROFILES_DESIGNATION'),
		);
	}
