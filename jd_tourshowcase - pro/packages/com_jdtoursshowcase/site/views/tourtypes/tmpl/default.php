...
$canCreate  = $user->authorise('core.create', 'com_jdtoursshowcase') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'tourtypeform.xml');
$canEdit    = $user->authorise('core.edit', 'com_jdtoursshowcase') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'tourtypeform.xml');
