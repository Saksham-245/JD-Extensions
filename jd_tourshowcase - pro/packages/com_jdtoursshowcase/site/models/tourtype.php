 ...
 * @since  1.6
 */
class JdtoursshowcaseModelTourtype extends JModelItem
{
    public $_item;
	...
	protected function populateState()
	{
		...
		{
			$id = Factory::getApplication()->getUserState('com_jdtoursshowcase.edit.tourtype.id');
		}
		else
		{
			$id = Factory::getApplication()->input->get('id');
			Factory::getApplication()->setUserState('com_jdtoursshowcase.edit.tourtype.id', $id);
		}

		$this->setState('tourtype.id', $id);
		...
		{
			$this->setState('tourtype.id', $params_array['item_id']);
		}
	...
	{
		// Get the id.
		$id = (!empty($id)) ? $id : (int) $this->getState('tourtype.id');
