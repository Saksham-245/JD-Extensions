 ...
 * @since  1.6
 */
class JdtoursshowcaseViewReview extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JDTOURSSHOWCASE_TITLE_REVIEW'), 'review.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_jdtoursshowcase.review', $this->item->id);
		}
