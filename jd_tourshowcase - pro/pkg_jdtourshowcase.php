...
class pkg_jdtourshowcaseInstallerScript {
      ...
      ?>
		...
		<div class="package-install">
			...
			<div class="install-message">
				<h3>JD Tours Showcase pro</h3>
				<p>Showcase your tours  in an Extraordinary way with JD Tours management Joomla Extension.</p>
			</div>
