   ...
   public function displayPackageWelcome() {
      ...
      <div class="package-install">
         ...
         <div class="install-message">
            <h3>JD Profile Pro<span>v1.0</span></h3>
            <p>Showcase your Team Members in an Extraordinary way with JD Profiler Team Management Joomla Extension</p></p>
         </div>
         <div class="package-install-actions">
            <a href="index.php?option=com_jdprofiler" class="btn btn-default">Get started</a>
         </div>
