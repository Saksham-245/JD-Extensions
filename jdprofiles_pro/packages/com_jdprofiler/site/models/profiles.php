...
class JdprofilerModelProfiles extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->join('LEFT', '#__jdprofiler_designation AS `designation` ON `designation`.id = a.`designation`');
		...
		if (!Factory::getUser()->authorise('core.edit', 'com_jdprofiler'))
		{
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_JDPROFILER_SEARCH_FILTER_DATE_FORMAT"), "warning");
