...
class JdprofilerHelper
{
	...
	public static function addSubmenu($vName = '')
	{
		...
		JHtmlSidebar::addEntry(
			JText::_('COM_JDPROFILER_TITLE_DESIGNATIONS'),
			'index.php?option=com_jdprofiler&view=designations',
			$vName == 'designations'
		);
		...
		JHtmlSidebar::addEntry(
			JText::_('COM_JDPROFILER_TITLE_SKILLS'),
			'index.php?option=com_jdprofiler&view=skills',
			$vName == 'skills'
		);
