	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="profileList">
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_JDPROFILER_PROFILES_NAME', 'a.`name`', $listDirn, $listOrder); ?>
				</th>
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_JDPROFILER_PROFILES_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
