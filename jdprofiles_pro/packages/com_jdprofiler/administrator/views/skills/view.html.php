 ...
 * @since  1.6
 */
class JdprofilerViewSkills extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JdprofilerHelper::addSubmenu('skills');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JDPROFILER_TITLE_SKILLS'), 'skills.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_jdprofiler&view=skills');
	}
