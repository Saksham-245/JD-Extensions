...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_jdprofiler&task=skills.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_jdprofiler&view=skills'); ?>" method="post"
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="skillList">
				...
				<tr>
					...
					<th class='left'>
						<?php echo JHtml::_('searchtools.sort',  'COM_JDPROFILER_SKILLS_TITLE', 'a.`title`', $listDirn, $listOrder); ?>
					</th>
					<th class='left'>
						<?php echo JHtml::_('searchtools.sort',  'COM_JDPROFILER_SKILLS_ID', 'a.`id`', $listDirn, $listOrder); ?>
					</th>
				...
				<td>
				<a href="<?php echo JRoute::_('index.php?option=com_jdprofiler&task=skill.edit&id='.(int) $item->id); ?>"><?php echo $item->title; ?></a>
				</td>
				<td>
