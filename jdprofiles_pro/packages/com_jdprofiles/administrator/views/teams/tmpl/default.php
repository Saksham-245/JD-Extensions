...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_jdprofiles&task=teams.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_jdprofiles&view=teams'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="teamList">
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_jdprofiles&task=team.edit&id='.(int) $item->id); ?>">
