 ...
 * @since  1.6
 */
class JdprofilesViewTeams extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JdprofilesHelper::addSubmenu('teams');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JDPROFILES_TITLE_TEAMS'), 'teams.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_jdprofiles&view=teams');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_JDPROFILES_TEAMS_TITLE'),
