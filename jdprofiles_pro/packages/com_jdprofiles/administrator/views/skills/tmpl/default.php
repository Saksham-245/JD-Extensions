...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_jdprofiles&task=skills.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_jdprofiles&view=skills'); ?>" method="post"
			...
			<table class="table table-striped" id="skillList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'skills.', $canChange, 'cb'); ?>
						</td>
						<?php endif; ?>
