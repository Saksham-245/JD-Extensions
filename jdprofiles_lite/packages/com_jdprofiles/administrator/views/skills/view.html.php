 ...
 * @since  1.6
 */
class JdprofilesViewSkills extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JdprofilesHelper::addSubmenu('skills');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JDPROFILES_TITLE_SKILLS'), 'skills.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				{
					JToolbarHelper::custom('skills.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
				}
			}
		...
		JHtmlSidebar::setAction('index.php?option=com_jdprofiles&view=skills');
	}
