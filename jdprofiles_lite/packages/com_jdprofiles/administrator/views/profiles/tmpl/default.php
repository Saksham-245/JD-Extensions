...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_jdprofiles&task=profiles.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_jdprofiles&view=profiles'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="profileList">
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_JDPROFILES_PROFILES_PHONE', 'a.`phone`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
